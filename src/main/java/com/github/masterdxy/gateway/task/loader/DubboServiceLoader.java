 ...
 * @author tomoyo
 */
@Component public class DubboServiceLoader extends AbstractScheduledService implements TaskRegistry.Task {
        ...
        try {
            ...
            metaData.forEach(stringStringKeyValue -> {
                ...
                if (StringUtils.isNotBlank(defKey) && !StringUtils.equalsIgnoreCase(
                    defKey.split(MetadataIdentifier.SEPARATOR)[2], SIDE_CONSUMER)) {
